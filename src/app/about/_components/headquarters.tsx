    ...
    <section className="lg:px-15.5">
      ...
      <ul className="flex flex-col md:flex-row gap-20 lg:gap-24  mt-18">
        {headquarters.map((hq) => (
          ...
          >
            <hq.Icon />
            <h3 className="text-h3 text-body leading-[36px] md:text-[24px] lg:text-[32px] whitespace-nowrap mt-12">
              {hq.name}
            </h3>
            <p className="text-content text-body text-center md:text-left mt-5.5 lg:mt-6">
              <hq.Content />
            </p>
          </li>
        ))}
